    ...
    <div className="info-container">
      <div className="info-card">
        ...
        <p className="info-information">
          ...
          table, ensuring that every meal is crafted to perfection with the finest
          ingredients.
        </p>
      </div>
      <div className="info-card">
        ...
        <p className="info-information">
          ...
          dish is prepared using only the freshest and finest ingredients available.
        </p>
      </div>
      <div className="info-card">
        ...
        <p className="info-information">
          ...
          order your favorite meals with just a few clicks, and have them delivered
          to your doorstep.
        </p>
      </div>
      <div className="info-card">
        ...
        <p className="info-information">
          We offer round-the-clock service to cater to all your food cravings, no
          matter the time of day or night. We are always here to serve you!
        </p>
      </div>
    </div>
  );
